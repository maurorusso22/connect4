...
: INIT_FLAG_DRAW 0 FLAG_DRAW ! ;
: ACTIVATE_FLAG_DRAW -1 FLAG_DRAW ! ;
: FLAG_DRAW_VALUE FLAG_DRAW @ ;
...
: IS_NOT_DRAW
    ...
    BEGIN
        ...
        BEGIN
            ...
            THEN
            INCREMENT_COLUMN_COUNTER
            COLUMN_LIMIT FLAG_DRAW_VALUE OR
        UNTIL
        INCREMENT_ROW_COUNTER
        ROW_LIMIT FLAG_DRAW_VALUE OR
    UNTIL
    INIT_ROW_COUNTER
    INIT_COLUMN_COUNTER
    FLAG_DRAW_VALUE
...
: PRINT_DRAW
    45 EMIT 45 EMIT 45 EMIT SPACE 68 EMIT 82 EMIT 65 EMIT 87 EMIT SPACE 45 EMIT 45 EMIT 45 EMIT CR
    \ --- DRAW ---
    PRINT_RESET
;
